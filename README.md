...
**Windows 发布包**：[下载 AI Workbench v0.1.0](https://github.com/hhzz-svg/ai-workbench/releases/tag/v0.1.0)
...
1. 从 [AI Workbench v0.1.0 Release](https://github.com/hhzz-svg/ai-workbench/releases/tag/v0.1.0) 下载 `ai-workbench-windows-0.1.0.zip`
2. 解压后双击 `install.bat`
3. 双击 `start.bat`
